                ...
                <div className="container mx-auto py-15 relative z-10">
                    <div className="flex flex-col md:flex-row items-center justify-items-center">
                        <div className="w-full md:w-[60%] p-4">
                            ...
                            <p className="text-white mt-5"> At PNCC, we've been keeping Palau connected since 1972. From mobile and internet to TV and custom tech solutions, we're here to serve every island and every community. Our team is passionate about bridging distances and bringing people closer - because for us, it's not just aboutthe technology, it's about connections. </p>
                        </div>
